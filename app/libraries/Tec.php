...
class Tec
{
    ...
    function filetype(){
        return 'gif|jpg|png|pdf|doc|docx|xls|xlsx|zip';
    }
    ...
    function baseUnit($qty, $unitObj) {
        ...
        switch($unitObj->operation) {
            case '*':
                return $qty*$unitObj->operation_value;
                break;
            case '/':
                return $qty/$unitObj->operation_value;
                break;
    ...
    function calculate_money($amount, $unitObj) {
        switch($unitObj->operation) {
            case '*':
                return number_format($amount*$unitObj->rate) .' '.$unitObj->symbol;
                break;
            case '/':
                return $amount/$unitObj->rate;
                break;
        }
    }
