            ...
            <div class="box-body">
                <div class="form-container">
                    <div class="col-xl-6 col-sm-8 col-xs-12">
                         <?php echo form_open_multipart("floors/create/" . $category->id); ?>
                            <div class="mb-2">
                                ...
                                ?>
                                <?php echo form_dropdown('branch', $brach, set_value('branch'), 'class="form-control tip select2" style="width:100%;" id="branch"  required="required"');?>
                            </div>
                            <div class="mb-2">
