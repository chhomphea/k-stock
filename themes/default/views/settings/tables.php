...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#PData').DataTable({
            ...
            'ajax' : { url: '<?=site_url('settings/get_tables');?>', type: 'POST', "data": function ( d ) {
            ...
            <div class="box-header">
                <h3 class="box-title"><?= lang('list_results'); ?></h3>
                    <ul class="nav navbar-nav pull-right">
                        <a href="<?= site_url('settings/add_table'); ?>" title="<?=lang('add_table')?>" class='' data-toggle='ajax'>
                        ...
                        <table id="PData" class="table table-bordered table-hover table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-xs-2"><?= lang("order_by"); ?></th>
                                    <th class="col-xs-2"><?= lang("group_table"); ?></th>
                                    <th class="col-xs-3"><?= lang("price_group_name"); ?></th>
