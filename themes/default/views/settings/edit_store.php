    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <?php echo form_open_multipart("settings/edit_store/".$store->id,'class="validation"');?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group" style="display:block;">
                            ...
                            <?= form_input('name', set_value('name', $store->name), 'class="form-control input-sm" id="name" required="required"'); ?>
                        </div>

                        <div class="form-group">
                            <label class="control-label" for="code"><?= $this->lang->line("code"); ?></label>
                            <?= form_input('code', set_value('code', $store->code), 'class="form-control input-sm" id="code" required="required"'); ?>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <?= form_input('phone', set_value('phone', $store->phone), 'class="form-control input-sm" id="phone" required="required"');?>
                        </div>
