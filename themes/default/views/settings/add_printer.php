...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header" style="background: #2649a5">
            ...
            <h5 class="box-title" style="color: #fff;font-size: 18px;"><?= lang('add_printer'); ?></h5>
        </div>
        <div class="modal-body">
            
                <div class="box-body">
                    <?php echo form_open_multipart("settings/add_printer", 'class="validation"');?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="network">
                            <div class="form-group">
                                ...
                                <?= form_input('ip_address', set_value('ip_address'), 'class="form-control" id="ip_address" required="required"'); ?>
                            </div>
