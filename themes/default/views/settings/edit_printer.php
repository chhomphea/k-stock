...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header" style="background-color: #2649a5">
            ...
            <h5 class="box-title" style="color: #fff;font-size: 18px"><?= lang('update_printer'); ?></h5>
        </div>
        <div class="modal-body">
                <div class="box-body">
                    <?php echo form_open_multipart("settings/edit_printer/".$printer->id."",'class="validation"');?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="network">
                            <div class="form-group">
                                ...
                                <?= form_input('ip_address', set_value('ip_address', $printer->ip_address), 'class="form-control" id="ip_address" required="required"'); ?>
                            </div>
