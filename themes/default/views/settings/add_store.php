	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				...
				<div class="box-body">
					<?php echo form_open_multipart("settings/add_store",'class="validation"');?>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<?= form_input('code', set_value('code'), 'class="form-control input-sm" id="code" required="required"'); ?>
						</div>
						...
						<div class="form-group">
							...
							<?= form_input('phone', set_value('phone'), 'class="form-control input-sm" id="phone" required="required"');?>
						</div>
						...
						<div class="form-group">
							...
							<?= form_input('country', set_value('country'), 'class="form-control input-sm" id="country" required="required"');?>
						</div>
