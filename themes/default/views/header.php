...
<head>
    ...
    <style>
        ...
        .menu-link { display: flex; align-items: center; justify-content: space-between; padding: 10px 20px; color: #000; text-decoration: none; border-radius: 0; font-weight: 500; font-size: 13.5px; transition: all 0.2s; cursor: pointer; border-left: 1px solid transparent; }
        ...
        .submenu-link { display: flex; align-items: center; padding: 8px 20px 8px 52px; font-size: 13px; color: #000; text-decoration: none; border-left: 3px solid transparent; opacity: 0.7; }
        ...
        .header-btn { padding: 6px 0; color: #000; text-decoration: none; display: flex; align-items: center; gap: 8px; font-weight: 500; font-size: 13px; border: none; background: transparent; }
        ...
        .card-header { background: #fff; border-bottom: 1px solid var(--border-color); padding: 12px 20px; font-size: 15px; font-weight: 700; color: #000; border-radius: 0 !important; }
        .card-body { padding: 20px; }
        
        .btn-sm { padding: 5px 12px !important; font-size: 12.5px !important; line-height: 1.5; height: auto; border-radius: 4px; }
        .btn-primary { background-color: var(--primary); border: 1px solid var(--primary); font-size: 13px; font-weight: 500; }
        ...
        table.dataTable tbody td { border-bottom: 1px solid #f1f5f9; font-size: 13px; padding: 4px 5px !important; vertical-align: middle; white-space: nowrap; }
        ...
        .dataTables_wrapper .dataTables_filter { padding: 10px 14px !important; color: var(--text-muted); display: flex; align-items: center; }
    ...
    <aside class="main-sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="menu-item has-child"> 
                <a class="menu-link" href="#" onclick="toggleSubmenu(this)">
                    <div class="d-flex align-items-center">
