            ...
            <div class="box-body">
                <div class="form-container">
                    <div class="col-xl-6 col-sm-8 col-xs-12">
                         <?php echo form_open_multipart("rooms/edit/" . $rowData->id); ?>
                            <div class="mb-2">
...
<?php
    $floor[] = lang('please_select');
    foreach ($floors as $key => $row) {
        $floor[$row->id] = $row->name;
    }
?>
                                <?php echo form_dropdown('floor', $floor, set_value('floor', $rowData->floor_id), 'class="form-control tip select2" style="width:100%;" id="floor"  required="required"');?>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <?php echo form_input('price', set_value('price', $rowData->price), 'class="form-control tip" id="price"  required="required"');?>
                            </div>
                            <div class="mb-2">
