                        ...
                        <div class="col-lg-6">
                            ...
                            <?php if ($Admin && $id != $this->session->userdata('user_id')) { ?>
                                ...
                                <div class="form-group store-con">
                                    ...
                                    echo form_dropdown('printer', $pr,$user->printer, 'id="printer_id" data-placeholder="' . lang("select") . ' ' . lang("printer") . '" class="form-control input-tip select2" style="width:100%;"');
                                    ?>
                                </div>
                                    ...
                                    <div class="panel-body" style="padding: 5px;">
                                            <div class="col-md-12">
                                               <div class="form-group">
                                                    ...
                                                    echo form_dropdown('show_all_record', $opt, (isset($_POST['show_all_record']) ? $_POST['show_all_record'] : $user->show_all_record), 'id="status" data-placeholder="' . lang("please") . ' ' . lang("select") . '" class="form-control input-tip select2" style="width:100%;"');
                                                    ?>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                               <div class="form-group">
                                                    ...
                                                    <?php
                                                    $opt = array('' => '', 1 => lang('enable'), 0 => lang('disable'));
                                                    echo form_dropdown('edit_price_sell', $opt, (isset($_POST['edit_price_sell']) ? $_POST['edit_price_sell'] : $user->edit_price_sell), 'id="status" data-placeholder="' . lang("please") . ' ' . lang("select") . '" class="form-control input-tip select2" style="width:100%;"');
                                                    ?>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                               <div class="form-group">
                                                    ...
                                                    <?php
                                                    $opt = array('' => '', 1 => lang('enable'), 0 => lang('disable'));
                                                    echo form_dropdown('allow_discount', $opt, (isset($_POST['allow_discount']) ? $_POST['allow_discount'] : $user->allow_discount), 'id="status" data-placeholder="' . lang("please") . ' ' . lang("select") . '" class="form-control input-tip select2" style="width:100%;"');
                                                    ?>
                                                </div>
                                            </div>
                                        </div>
                               ...
                               <!--  <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="checkbox" for="edit_price_sell">
                                        <input type="checkbox" name="edit_price_sell" value="1" id="edit_price_sell"  <?php echo $user->{'edit_price_sell'} ? "checked" : ''; ?> /> <?= lang('edit_price_sell') ?></label>
                                </div>
                                <div class="form-group store-con">
                                    <label class="checkbox" for="allow_discount"><input type="checkbox" name="allow_discount" value="1" id="allow_discount" <?php echo $user->{'allow_discount'} ? "checked" : ''; ?> /> <?= lang('allow_discount') ?></label>
                                </div> -->
                            <?php } ?>
