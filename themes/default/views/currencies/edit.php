            ...
            <div class="box-body">
                <div class="form-container">
                    <div class="col-xl-6 col-sm-8 col-xs-12">
                         <?php echo form_open_multipart("currencies/edit/" . $rowData->id); ?>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <?php echo form_input('symbol', set_value('symbol', $rowData->symbol), 'class="form-control tip" id="symbol" required="required"');?>
                            </div>
                            <div class="mb-2">
                                <?php echo lang('rate', 'rate');?>
                                <?php echo form_input('rate', set_value('rate', $rowData->rate), 'class="form-control tip" id="rate" required="required"');?>
                            </div>
                            <div class="mb-2">
                                <?php echo lang('operator', 'operator');?>
<?php $opertors = ['*' => lang('multiple'), '/' => lang('divition')]; ?>
                                <?php echo form_dropdown('operator', $opertors, set_value('operator', $rowData->operator), 'class="form-control tip select2" style="width:100%;" id="operator"  required="required"');?>
                            </div>
                            <div class="mb-2">
