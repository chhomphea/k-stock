...
function formatExchange(amount,e) {
    
    if (Settings.display_symbol==1) {
        return e +  formatSA(parseFloat(amount).toFixed(Settings.decimals));
    }else{
        return formatNumber(parseFloat(amount).toFixed(0),0) + e ;
    }
}
